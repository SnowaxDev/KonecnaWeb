...
const HomePage = () => {
  const services = [
    {
      icon: Scissors,
      title: 'Sekání trávy',
      description: 'Profesionální sekání trávníků všech velikostí. Pravidelná údržba nebo jednorázová služba.',
  ...
  const faqItems = [
    {
      question: 'Jak zjistím cenu za sekání zahrady ve Dvoře Králové?',
      answer: 'Stačí nás kontaktovat – přijedeme na bezplatnou obhlídku vaší zahrady nebo pozemku a na místě vám sdělíme přesnou cenu. Žádné překvapení, cenu vždy znáte předem.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Služba pro pozemky, parcely a zahrady silně zarostlé křovinami, náletovými dřevinami nebo přerostlou vegetací. Provádíme kompletní vyčištění – kácení, mulčování, odvoz odpadu a finální úklid.',
    },
  ];
  ...
  return (
    <div className="min-h-screen" data-testid="home-page">
      <SEOHead 
        title="Sekání trávy Dvůr Králové nad Labem | Zahradnické služby | SeknuTo.cz"
        description="Profesionální sekání trávy, likvidace zarostlých pozemků a údržba zahrad ve Dvoře Králové nad Labem a okolí (Trutnov, Vrchlabí, Jaroměř, Náchod). Bezplatná obhlídka zdarma. ☎ 730 588 372"
        keywords="sekání trávy Dvůr Králové, zahradnické služby Dvůr Králové nad Labem, sekání trávy Trutnov, sekání trávy Vrchlabí, likvidace pozemků, čištění parcel, vertikutace trávníku, hnojení trávy, zahradník Dvůr Králové, údržba zahrady Královéhradecký kraj"
        schema={[SCHEMAS.webSite, SCHEMAS.localBusiness, SCHEMAS.faqPage(faqItems), ...SCHEMAS.reviews(reviews)]}
      />
      {/* Hero Section */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="text-left">
              ...
              >
                Sekání trávy{' '}
                <span className="text-[#2E8B3E]">Dvůr Králové</span>{' '}
                a okolí
              </h1>
