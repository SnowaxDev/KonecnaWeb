...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen pt-20" data-testid="contact-page">
      <SEOHead
        title="Kontakt – Zahradnické služby Dvůr Králové | SeknuTo.cz"
        description="Kontaktujte SeknuTo.cz pro bezplatnou obhlídku zahrady. ☎ 730 588 372. Sekání trávy, likvidace pozemků a zahradnické služby ve Dvoře Králové nad Labem, Trutnov, Vrchlabí a okolí."
        keywords="kontakt zahradník Dvůr Králové, sekání trávy poptávka, zahradnické služby telefon, bezplatná obhlídka zahrada, SeknuTo kontakt"
        canonical="https://seknuto.cz/kontakt"
        schema={[SCHEMAS.localBusiness, SCHEMAS.breadcrumb([{ name: 'Úvod', url: '/' }, { name: 'Kontakt', url: '/kontakt' }])]}
      />
      {/* Hero */}
